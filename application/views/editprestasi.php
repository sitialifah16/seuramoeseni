                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="<?php echo base_url('index.php/admin/dataPrestasi');?>">Data Prestasi</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Edit Prestasi</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-10" style="margin:0 auto">
                                        <div class="card">
                                            <div class="card-body"> 
                                                ...
                                                <?php echo form_open('admin/proses_editprestasi'); ?>
                                                <?php foreach ($prestasi as $press){ ?>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="text" name="prestasi" id="prestasi" value="<?php echo $prestasi[0]->prestasi; ?>" class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="text" name="kategori"  id="kategori" value="<?php echo $prestasi[0]->kategori; ?>" class="form-control"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="tahun" name="tahun"  id="jurusan" value="<?php echo $prestasi[0]->tahun; ?>" class="form-control"/> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label">Id_Prestasi</label>
                                                                <div class="col-sm-6">
                                                                    <input type="text" name="id" value="<?php echo $id_prestasi; ?>" class="form-control" readonly/> 
                                                                </div>
                                                            </div>
                                                        </div>  
                                                        <div class="pull-left">
