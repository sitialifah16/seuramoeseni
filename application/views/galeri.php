                ...
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        ...
                        <div class="responsive">
                          <div class="gallery">
                            <a target="_blank" href="<?php echo base_url('assets/');?>img/bg-img/1.jpg">
                              <img src="<?php echo base_url('assets/');?>img/bg-img/1.jpg" alt="Cinque Terre" width="800" height="600">
                            </a>
                            <div class="desc">PEMBUKAAN INFEST 2018 </div>
                          </div>
                        </div>

                        <div class="responsive">
                          <div class="gallery">
                            <a target="_blank" href="<?php echo base_url('assets/');?>img/bg-img/a4a.jpg">
                              <img src="<?php echo base_url('assets/');?>img/bg-img/a4a.jpg" alt="Forest" width="800" height="600">
                            </a>
                            <div class="desc">LOMBA TARI KREASI</div>
                          </div>
                        </div>

                        <div class="responsive">
                          <div class="gallery">
                            <a target="_blank" href="<?php echo base_url('assets/');?>img/bg-img/a3.jpg">
                              <img src="<?php echo base_url('assets/');?>img/bg-img/a3.jpg" alt="Northern Lights" width="800" height="600">
                            </a>
                            <div class="desc">ACEH REI EXPO</div>
                          </div>
                        </div>

                        <div class="responsive">
                          <div class="gallery">
                            <a target="_blank" href="<?php echo base_url('assets/');?>img/bg-img/1a.jpg">
                              <img src="<?php echo base_url('assets/');?>img/bg-img/1a.jpg" alt="Mountains" width="800" height="600">
                            </a>
                            <div class="desc">ANNIVERSARY SSM</div>
                          </div>
                        </div>

                        <div class="responsive">
                          <div class="gallery">
                            <a target="_blank" href="<?php echo base_url('assets/');?>img/bg-img/a5a.jpg">
                              <img src="<?php echo base_url('assets/');?>img/bg-img/a5a.jpg" alt="Mountains" width="800" height="600">
                            </a>
                            <div class="desc">PELANTIKAN PENGURUS</div>
                          </div>
                        </div>

                        <div class="responsive">
                          <div class="gallery">
                            <a target="_blank" href="<?php echo base_url('assets/');?>img/bg-img/a7.jpg">
                              <img src="<?php echo base_url('assets/');?>img/bg-img/a7.jpg" alt="Mountains" width="800" height="600">
                            </a>
                            <div class="desc">PAKARMARU FMIPA 2018</div>
                          </div>
                        </div>

                        <div class="responsive">
                          <div class="gallery">
                            <a target="_blank" href="<?php echo base_url('assets/');?>img/bg-img/a8.jpg">
                              <img src="<?php echo base_url('assets/');?>img/bg-img/a8.jpg" alt="Mountains" width="800" height="600">
                            </a>
                            <div class="desc">KONSER AMAL PALU</div>
                          </div>
                        </div>

                        <div class="responsive">
                          <div class="gallery">
                            <a target="_blank" href="<?php echo base_url('assets/');?>img/bg-img/a10.jpg">
                              <img src="<?php echo base_url('assets/');?>img/bg-img/a10.jpg" alt="Mountains" width="800" height="600">
                            </a>
                            <div class="desc">PENUTUPAN PIL MIPA 2018</div>
                          </div>
                        </div>
                    </div>
            </div>
