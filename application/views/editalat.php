                                    ...
                                    <div class="col-lg-10" style="margin:0 auto">
                                        <div class="card">
                                            <div class="card-body"> 
                                                ...
                                                <?php echo form_open_multipart('admin/proses_editbarang'); ?>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="text" name="nama_alat" id="nama_alat" value="<?php echo $sewa[0]->nama_alat; ?>" class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="text" name="jumlah"  id="jumlah" value="<?php echo $sewa[0]->Jumlah; ?>" class="form-control"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="text" name="harga_sewa"  id="harga_sewa" value="<?php echo $sewa[0]->harga_sewa; ?>" class="form-control"/> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <img src="<?php echo base_url() . 'uploads/barang/' . $sewa[0]->gambar ?>" alt="">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="text" name="id" value="<?php echo $id_alat; ?>" class="form-control" readonly/> 
                                                                </div>
                                                            </div>
                                                        </div>  
                                                        <div class="pull-left">
