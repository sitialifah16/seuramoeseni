            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        ...
                        <h6 style="text-align: justify">SYARAT DAN KETENTUAN PENDAFTARAN</h6>
                        <p style="text-align: justify">
                            1. Pendaftar merupakan Mahasiswa Aktif Fakultas MIPA Universitas Syiah Kuala tahun 2018-2019.
                            <br>
                            2. Pendaftar merupakan mahasiswa fakultas MIPA minimal semester 1 dan maksimal semester 3
                            <br>
                            3. Pendaftar memiliki bakat di bidang seni,seperti musik, tari atau membaca puisi. 
                            <br>
                            4. Pendaftar bersedia berkontribusi dalam kegiatan Seuramoe Seni MIPA UNSYIAH.
                            <br>
                            5. Pendaftar bersedia mengikuti tes tahap lanjut apabila lulus.
                        </p>
                        <br>
                        <br>
                        <h6>UNTUK MENDAFTAR, KLIK LINK DIBAWAH INI</h6>
                        <br>

                        <form action="<?php echo base_url('index.php/web/formdaftar'); ?>" method="post" class="form-inline">
                            <div class="col-12">
