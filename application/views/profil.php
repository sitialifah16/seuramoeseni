            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        ...
                        <h6>Perjalanan Kami dari Masa ke Masa</h6>
                            <img src="<?php echo base_url('assets/');?>img/bg-img/5.jpg" alt="Paris" class="center" width="800" height="500">
                            <br>
                            <br>
                            <h1 style="text-align: justify">
                                Latar belakang dibentuknya UKM Seuramoe Seni MIPA berawal dari mahasiswa dari fakultas lain yang memandang bahwa mahasiswa FMIPA merupakan mahasiswa yang hanya berfokus pada kegiatan akademik, sedangkan tidak ada wadah yang menampung aspirasi dan bakat mahasiswa di bidang non akademik. Hal tersebut mendorong mahasiswa FMIPA untuk membentuk suatu unit kegiatan yang dapat menampung bakat dan kreativitas mahasiswa di bidang seni. 
                ...
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        ...
                        <h6> VISI </h6>
                        <h1 style="text-align: justify">
                            1. Sebagai wadah untuk mengembangkan kreativitas mahasiswa
                            <br>
                            2.Menjadi pusat seni dan budaya dengan menerapkan nilai-nilai seni dan budaya yaitu kemandirian, kepedulian sosial, keakraban, keteguhan hati dan silaturahmi antar sesama mahasiswa FMIPA.
                        </h1>
                        <br>
                        <h6> MISI </h6>
                        <h1 style="text-align: justify">
                            1. Menyalurkan minat dan bakat mahasiswa
                            <br>
                            2. Mengembangkan dan melestarikan seni dan budaya
                            <br>
                            3. Membina sikap disiplin untuk melaksanakan dan menyukseskan kegiatan organisasi.
                            <br>
                            4. Menjadikan kampus sebagai ajang interaktif untuk kegiatan positif khusunya di bidang seni. 
                        </h1>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        ...
                        <div class="line-shape"></div>
                        <br>
                        <h6 style="margin-right: 700px"> Tahun 2013 </h6>
                        <h1 style="text-align: justify">
                            1. Juara II Lomba Tari Daerah
                        </h1>
                        <br>
                        <h6 style="margin-right: 700px"> Tahun 2014 </h6>
                        <h1 style="text-align: justify">
                            1. Juara Harapan II Lomba Paduan Suara
                            <br>
                            2. Juara III Lomba Tari Ratoeh Jaroe pada Festival Ratoeh
                        </h1>
                        <br>
                         <h6 style="margin-right: 700px"> Tahun 2015 </h6>
                        <h1 style="text-align: justify">
                            1. Juara III Lomba Vocal Solo
                        </h1>
                        <br>
                        <h6 style="margin-right: 700px"> Tahun 2016 </h6>
                        <h1 style="text-align: justify">
                            -
                        </h1>
                        <br>
                        <h6 style="margin-right: 700px"> Tahun 2017 </h6>
                        <h1 style="text-align: justify">
                            1. Juara II Lomba Tari Kreasi di Yamaha Modification
                            <br>
                            2. Juara I Tari Nusantara di Acara
                            <br>
                            3. Juara II Kompetisi Aceh Etnik
                        </h1>
                        <br>
                        <h6 style="margin-right: 700px"> Tahun 2018 </h6>
                        <h1 style="text-align: justify">
                            1. Juara II FestBand di Uin Ar-Raniry
                            <br>
                            2. Juara II Tari Nusantara
                            <br>
                            3. Juara harapan III Lomba Akustik
