                ...
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        ...
                        <div class="line-shape"></div>
                            <h6>PARADE GELAP 2015</h6>
                            <img src="<?php echo base_url('assets/');?>img/bg-img/a1.jpg" alt="Paris" class="center" width="800" height="600">
                            <br>
                            <br>
                            <h1 style="text-align: justify">
                                Parade Gelap 2015 merupakan salah satu acara tahunan yang diselenggarakan oleh UKM Seuramoe Seni MIPA UNSYIAH. Acara ini diadakan setiap 2 tahun sekali. Acara berisi perlombaan band yang terbuka untuk umum, penampilan-penampilan dari UKM dan donor darah. 
                            </h1>
                            <br>
                            <br>
                            <h6>PARADE GELAP 2017</h6>
                            <img src="<?php echo base_url('assets/');?>img/bg-img/a2.jpg" alt="Paris" class="center" width="800" height="600">
                            <br>
                            <br>
                            <h1 style="text-align: justify">
                                Parade Gelap 2017 merupakan salah satu acara tahunan yang diselenggarakan oleh UKM Seuramoe Seni MIPA UNSYIAH. Acara ini diadakan setiap 2 tahun sekali. Acara berisi perlombaan band yang terbuka untuk umum, penampilan-penampilan dari UKM dan donor darah. 
                            </h1>
                            <br>
                            <br>
                            <h6>DIKLATSAR</h6>
                            <img src="<?php echo base_url('assets/');?>img/bg-img/diksar.jpg" alt="Paris" class="center" width="800" height="600">
                            <br>
                            <br>
                            <h1 style="text-align: justify">
                                Diklatsar merupakan kepanjangan dari Pendidikan Latihan Dasar. Diklatsar adalah salah satu acara tahunan yang diselenggarakan oleh UKM Seuramoe Seni MIPA UNSYIAH. Acara ini dilakukan sebagai wadah untuk mendidik anggota UKM yang baru bergabung di UKM Seuramoe Seni MIPA UNSYIAH.
                            </h1>
                    </div>
                </div>
            </div>
