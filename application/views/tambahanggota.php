                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Tambah Anggota</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-10" style="margin:0 auto">
                                        <div class="card">
                                            <div class="card-body"> 
                                                ...
                                                <?php echo form_open('admin/proses_tambahanggota');?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="text" name="bakat"  id="bakat" class="form-control"> 
                                                                </div>
                                                            </div>
                                                        </div>  
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="number" placeholder="YYYY" min="2010" max="2100" name="tahun"  id="tahun" class="form-control"> 
                                                                </div>
                                                            </div>
                                                        </div>   
                                                        <div class="pull-left">
