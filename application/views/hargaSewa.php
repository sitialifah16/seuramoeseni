                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Harga Sewa</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div class="sparkline8-graph">
                                    ...
                                    <div id="toolbar">
                                            <div>
                                                <a href="<?php echo base_url().'index.php/admin/tambahbarang';?>" class="btn btn-primary" data-toogle="modal" data-target="input_data"><i class="fa fa-plus"></i>Tambah Barang</a>
                                            </div>
                                        </div>
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>  
                                                    ...
                                                    <th data-field="jumlah" data-editable="false">Jumlah</th>
                                                    <th data-field="harga" data-editable="false">Harga</th>
                                                    <th data-field="gambar" data-editable="false" width="100px">Gambar</th>
                                                    <th>Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php 
                                                $no = 1;
                                                foreach($tampilansewa as $sewa){ ?>
                                                <tr>
                                                    <td text-align="center"><?php echo $no++ ?></td>
                                                    <td><?php echo $sewa['nama_alat'] ?></td>
                                                    <td><?php echo $sewa['Jumlah'] ?></td>                                                   
                                                    <td><?php echo $sewa['harga_sewa'] ?></td>   
                                                    <td width="200px"><img src="<?php echo base_url(); ?>uploads/barang/<?php echo $sewa['gambar'] ?>" alt=""></td>   
                                                    <td width="200px">                                            
                                                        <div>
                                                            <a href="<?php echo base_url().'index.php/admin/editalat/'.$sewa['id_alat'];?>"><button>Edit</button></a>         
                                                            <a  onclick="return confirm('Are you sure you want to delete this entry?')" href="<?php echo base_url().'index.php/admin/hapussewa/'.$sewa['id_alat'];?>"><button>Hapus</button></a></td>
                                                        </div>   
                                                    </td>
                                                </tr>
                                                <?php } ?>
