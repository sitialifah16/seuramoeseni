                        ...
                        <h6>Harga Sewa Alat Musik</h6>
                         <table id="t01" style="width:100%">
                          ...
                          <tr>
                            ...
                            <td>3</td> 
                            <td>
                                <img src="<?php echo base_url('assets/');?>img/bg-img/gitar.jpg" alt="me" style="width: 130px" />
                            </td>
                          </tr>
                          <tr>
                            <td>Bass</td>
                            <td>2</td> 
                            <td>
                                <img src="<?php echo base_url('assets/');?>img/bg-img/bass.jpg" alt="me" style="width: 130px" />
                            </td>
                          </tr>
                          <tr>
                            <td>Cajon</td>
                            <td>2</td> 
                            <td>
                                <img src="<?php echo base_url('assets/');?>img/bg-img/cajon.jpg" alt="me" style="width: 130px" />
                            </td>
                          </tr>
                        </table>
                        <br>
